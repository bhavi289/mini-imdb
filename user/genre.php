 ...
 <?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "GET" and isset($_GET['genre']))
    {
	    $genre_id = $_GET['type'];
	    $genre_movies = $functions->get_movie_by_genre($genre_id);
	    echo "<script>console.log(".$genre_id.")</script>";
	...
	<div id="filtered-results">
		...
		<table class="highlight" >
			...
			<th>Release Date</th>
	      	...
	      	<?php foreach ($genre_movies as $uc) { ?>
	      		<tr>
