...
<body>
  ...
  <h2 style="margin-left: 35%">USER PROFILE :</h2><br>
    ...
    echo "<script>console.log(".$_GET['id'].")</script>";
		$viewer_profile = $functions->viewer_profile($_GET['id']);
    $viewer_profile_2 = $functions->viewer_profile_2($_GET['id']);
  ...
  STARS GIVEN TO MOVIE -<b> <?php echo $viewer_profile['star']; ?></b><br>
      ...
      <div class="card-content">
  LEAST LIKED MOVIE -<b> <?php echo $viewer_profile_2['name']; ?></b><br>
  STARS GIVEN TO MOVIE -<b> <?php echo $viewer_profile_2['star']; ?></b><br>
      </div>
